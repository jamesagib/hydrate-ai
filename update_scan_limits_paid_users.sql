-- Update Scan Limits for Paid Users
-- This file updates the scan limit for paid users from 5 to 10 scans per day

-- Update the process_drink_analysis function with new paid user limits
